...
TEST(AgradRevMatrix, divide_scalar_nan) {
  using stan::agrad::divide;
  ...
  EXPECT_TRUE(boost::math::isnan(divide(d1, v2).val()));
  EXPECT_TRUE(boost::math::isnan(divide(v1, d2).val()));
  EXPECT_TRUE(boost::math::isnan(divide(v1, v2).val()));
...
TEST(AgradRevMatrix, divide_vector_nan) {
  double nan = std::numeric_limits<double>::quiet_NaN();
  using stan::math::divide;
  using stan::math::vector_d;
  using stan::agrad::vector_v;
...
TEST(AgradRevMatrix, divide_rowvector_nan) {
  double nan = std::numeric_limits<double>::quiet_NaN();
  using stan::math::divide;
  using stan::math::row_vector_d;
  using stan::agrad::row_vector_v;
...
TEST(AgradRevMatrix, divide_matrix_nan) {
  double nan = std::numeric_limits<double>::quiet_NaN();
  using stan::math::divide;
  using stan::math::matrix_d;
  using stan::agrad::matrix_v;
