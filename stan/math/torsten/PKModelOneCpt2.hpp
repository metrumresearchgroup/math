#ifndef STAN_MATH_TORSTEN_PKMODELONECPT2_HPP
#define STAN_MATH_TORSTEN_PKMODELONECPT2_HPP
...
PKModelOneCpt2(const std::vector<T0>& time,
  ...
  PredWrapper<refactor::PKOneCptModel, refactor::PKOneCptModelSolver, refactor::PKOneCptModelSolverSS> pr;
...
PKModelOneCpt2(const std::vector<T0>& time,
  ...
  return PKModelOneCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
