#ifndef STAN_MATH_TORSTEN_GENERALODEMODEL2_BDF_HPP
#define STAN_MATH_TORSTEN_GENERALODEMODEL2_BDF_HPP
...
generalOdeModel2_bdf(const F& f,
                    const int nCmt,
  ...
  // check arguments
  static const char* function("generalOdeModel2_bdf");
...
generalOdeModel2_bdf(const F& f,
  ...
  return generalOdeModel2_bdf(f, nCmt,
