#ifndef STAN_MATH_TORSTEN_GENERALODEMODEL2_RK45_HPP
#define STAN_MATH_TORSTEN_GENERALODEMODEL2_RK45_HPP
...
generalOdeModel2_rk45(const F& f,
                     const int nCmt,
  ...
  // check arguments
  static const char* function("generalOdeModel2_rk45");
...
generalOdeModel2_rk45(const F& f,
  ...
  return generalOdeModel2_rk45(f, nCmt,
