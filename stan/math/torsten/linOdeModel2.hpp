#ifndef STAN_MATH_TORSTEN_LINODEMODEL2_HPP
#define STAN_MATH_TORSTEN_LINODEMODEL2_HPP
...
linOdeModel2(const std::vector<T0>& time,
  ...
  static const char* function("linOdeModel2");
...
linOdeModel2(const std::vector<T0>& time,
  ...
  return linOdeModel2(time, amt, rate, ii, evid, cmt, addl, ss,
