#ifndef STAN_MATH_TORSTEN_MIXODEONECPTMODEL2_BDF_HPP
#define STAN_MATH_TORSTEN_MIXODEONECPTMODEL2_BDF_HPP
...
mixOde1CptModel2_bdf(const F& f,
                     const int nOde,
  ...
  // check arguments
  static const char* function("mixOde1CptModel2_bdf");
...
mixOde1CptModel2_bdf(const F& f,
  ...
  return mixOde1CptModel2_bdf(f, nOde,
