#ifndef STAN_MATH_TORSTEN_MIXODE2CPTMODEL2_BDF_HPP
#define STAN_MATH_TORSTEN_MIXODE2CPTMODEL2_BDF_HPP
...
mixOde2CptModel2_bdf(const F& f,
                    const int nOde,
...
mixOde2CptModel2_bdf(const F& f,
  ...
  return mixOde2CptModel2_bdf(f, nOde,
