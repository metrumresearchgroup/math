...
TEST_F(TorstenPKTwoCptMPITest, bdf_solver_multiple_bolus_doses_data_only) {
    ...
    vector<Matrix<double, Dynamic, Dynamic> > x_m =
      torsten::generalOdeModel_bdf(model_t::f_, model_t::Ncmt, time_m, amt_m, rate_m, ii_m, evid_m, cmt_m, addl_m, ss_m, pMatrix_m, biovar_m, tlag_m); // NOLINT
...
TEST_F(TorstenPKTwoCptMPITest, bdf_solver_multiple_bolus_doses_par_var) {
    ...
    vector<Matrix<var, Dynamic, Dynamic> > x_m =
      torsten::generalOdeModel_bdf(model_t::f_, model_t::Ncmt, time_m, amt_m, rate_m, ii_m, evid_m, cmt_m, addl_m, ss_m, pMatrix_m_v, biovar_m, tlag_m); // NOLINT
...
TEST_F(TorstenPKTwoCptMPITest, rk45_solver_multiple_bolus_doses_data_only) {
    ...
    vector<Matrix<double, Dynamic, Dynamic> > x_m =
      torsten::generalOdeModel_rk45(model_t::f_, model_t::Ncmt, time_m, amt_m, rate_m, ii_m, evid_m, cmt_m, addl_m, ss_m, pMatrix_m, biovar_m, tlag_m); // NOLINT
...
TEST_F(TorstenPKTwoCptMPITest, rk45_solver_multiple_bolus_doses_par_var) {
    ...
    vector<Matrix<var, Dynamic, Dynamic> > x_m =
      torsten::generalOdeModel_rk45(model_t::f_, model_t::Ncmt, time_m, amt_m, rate_m, ii_m, evid_m, cmt_m, addl_m, ss_m, pMatrix_m_v, biovar_m, tlag_m); // NOLINT
