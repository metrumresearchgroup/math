...
#include <test/unit/math/prim/mat/fun/expect_matrix_eq.hpp>
#include <test/unit/math/torsten/util_PKModelTwoCpt2.hpp>
#include <vector>
...
TEST(Torsten, PKModelTwoCpt_MultipleDoses) {
  ...
  // test_PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
...
TEST(Torsten, PKModelTwoCpt_MultipleDoses_overload) {
  ...
  Matrix<double, Dynamic, Dynamic> x_122, x_112, x_111, x_121, x_212,
    x_211, x_221;
  x_122 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                        pMatrix[0], biovar, tlag);
  x_112 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                        pMatrix[0], biovar[0], tlag);
  x_111 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                        pMatrix[0], biovar[0], tlag[0]);
  x_121 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                        pMatrix[0], biovar, tlag[0]);
  x_212 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                        pMatrix, biovar[0], tlag);
  x_211 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                        pMatrix, biovar[0], tlag[0]);
  x_221 = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
...
TEST(Torsten, PKModelTwoCpt2_signature_test) {
  using stan::math::var;
  ...
  x_122[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar, tlag);
  x_122[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v, tlag);
  x_122[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar, tlag_v);
  x_122[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v, tlag_v);
  x_122[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v, tlag);
  x_122[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v, tlag_v);
  x_122[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
  ...
  x_112[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar[0], tlag);
  x_112[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v[0], tlag);
  x_112[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar[0], tlag_v);
  x_112[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v[0], tlag_v);
  x_112[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v[0], tlag);
  x_112[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v[0], tlag_v);
  x_112[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
  ...
  x_121[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar, tlag[0]);
  x_121[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v, tlag[0]);
  x_121[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar, tlag_v[0]);
  x_121[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v, tlag_v[0]);
  x_121[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v, tlag[0]);
  x_121[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v, tlag_v[0]);
  x_121[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
  ...
  x_111[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar[0], tlag[0]);
  x_111[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v[0], tlag[0]);
  x_111[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar[0], tlag_v[0]);
  x_111[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v[0], biovar_v[0], tlag_v[0]);
  x_111[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v[0], tlag[0]);
  x_111[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix[0], biovar_v[0], tlag_v[0]);
  x_111[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
  ...
  x_212[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar[0], tlag);
  x_212[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar_v[0], tlag);
  x_212[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar[0], tlag_v);
  x_212[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar_v[0], tlag_v);
  x_212[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix, biovar_v[0], tlag);
  x_212[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix, biovar_v[0], tlag_v);
  x_212[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
  ...
  x_211[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar[0], tlag[0]);
  x_211[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar_v[0], tlag[0]);
  x_211[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar[0], tlag_v[0]);
  x_211[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar_v[0], tlag_v[0]);
  x_211[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix, biovar_v[0], tlag[0]);
  x_211[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix, biovar_v[0], tlag_v[0]);
  x_211[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
  ...
  x_221[0] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar, tlag[0]);
  x_221[1] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar_v, tlag[0]);
  x_221[2] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar, tlag_v[0]);
  x_221[3] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix_v, biovar_v, tlag_v[0]);
  x_221[4] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix, biovar_v, tlag[0]);
  x_221[5] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
                           pMatrix, biovar_v, tlag_v[0]);
  x_221[6] = torsten::PKModelTwoCpt2(time, amt, rate, ii, evid, cmt, addl, ss,
...
TEST(Torsten, PKModelTwoCpt2_SS) {
...
TEST(Torsten, PKModelTwoCpt2_SS_rate) {
...
TEST(Torsten, PKModelTwoCpt2_MultipleDoses_timePara) {
...
TEST(Torsten, PKModelTwoCpt2Model_Rate) {
  using std::vector;
