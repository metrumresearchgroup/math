...
finite_diff_params(const std::vector<double>& time,
  ...
  pk_res_ub = torsten::linOdeModel2(time, amt, rate, ii, evid, cmt, addl, ss,
                          system_ub, biovar_ub, tlag_ub);
  pk_res_lb = torsten::linOdeModel2(time, amt, rate, ii, evid, cmt, addl, ss,
...
void test_linearOdeModel_finite_diff_vdd(
  ...
  // Compute return of linOdeModel2
  Matrix<var, Dynamic, Dynamic> ode_res
    = torsten::linOdeModel2(time, amt, rate, ii, evid, cmt, addl, ss,
...
void test_linearOdeModel_finite_diff_dvd(
  ...
  Matrix<var, Dynamic, Dynamic> ode_res;
  ode_res = torsten::linOdeModel2(time, amt, rate, ii, evid, cmt, addl, ss,
...
void test_linOdeModel2(const std::vector<double>& time,
                      const std::vector<double>& amt,
                      const std::vector<double>& rate,
                      const std::vector<double>& ii,
                      const std::vector<int>& evid,
