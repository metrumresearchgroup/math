...
finite_diff_params(const F& f,
  ...
  if (odeInt == "1_rk45") {
    pk_res_ub = torsten::mixOde1CptModel2_rk45(f, nOde, time, amt, rate, ii,
                                     evid, cmt, addl, ss,
                                     pMatrix_ub, biovar_ub, tlag_ub,
                                     0,
                                     rel_tol, abs_tol, max_num_steps);
    pk_res_lb = torsten::mixOde1CptModel2_rk45(f, nOde, time, amt, rate, ii,
                                     evid, cmt, addl, ss,
  ...
  if (odeInt == "1_bdf") {
    pk_res_ub = torsten::mixOde1CptModel2_bdf(f, nOde, time, amt, rate, ii,
                                    evid, cmt, addl, ss,
                                    pMatrix_ub, biovar_ub, tlag_ub,
                                    0,
                                    rel_tol, abs_tol, max_num_steps);
    pk_res_lb = torsten::mixOde1CptModel2_bdf(f, nOde, time, amt, rate, ii,
                                    evid, cmt, addl, ss,
                                    pMatrix_lb, biovar_lb, tlag_lb,
                                    0,
                                    rel_tol, abs_tol, max_num_steps);
...
void test_mixOdeCptModel_finite_diff_vdd(
  ...
  if (odeInt == "1_rk45")
    ode_res = torsten::mixOde1CptModel2_rk45(f, nOde,
  ...
  if (odeInt == "1_bdf")
    ode_res = torsten::mixOde1CptModel2_bdf(f, nOde,
                                  time, amt, rate, ii, evid, cmt, addl, ss,
                                  pMatrix_v, biovar, tlag,
                                  0,
                                  rel_tol, abs_tol, max_num_steps);
